function InterfazDosRobots()
    ...
    robotA;
    robotB;
    load('trayectorias_robots.mat','q1A','q1B','q2A','q2B','q3A','q3B');
    ...
    uicontrol('Parent', panel, 'Style','pushbutton', ...
        ...
        'Callback', @(~,~) animarDosRobots(RA,RB,q2A,q2B));
    ...
    uicontrol('Parent', panel, 'Style','pushbutton', ...
        'String','VueltaAPInicial', ...
        'FontSize',11,'Position',[20 150 200 40], ...
        'Callback', @(~,~) animarDosRobots(RA,RB,q3A,q3B));

    uicontrol('Parent', panel, 'Style','pushbutton', ...
        'String','SecuenciaCompleta', ...
        'FontSize',11,'Position',[20 100 200 40], ...
        'Callback', @(~,~) secuenciaCompleta(RA,RB,q1A,q1B,q2A,q2B,q3A,q3B));
...
function secuenciaCompleta(RA,RB,q1A,q1B,q2A,q2B,q3A,q3B)
    animarUnRobot(RA,q1A);
    animarUnRobot(RB,q1B);
    entraAuto();
    animarDosRobots(RA,RB,q2A,q2B);
    saleAuto();
    animarDosRobots(RA,RB,q3A,q3B);
