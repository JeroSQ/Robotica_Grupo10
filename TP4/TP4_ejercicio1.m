dh = [
    0.000  0.450  0.075  -90 0.000;
    0.000  0.000  0.300  0.000 0.000;
    0.000  0.000  0.075  -90 0.000;
    0.000  0.320  0.000  90 0.000;
    0.000  0.000  0.000  -90 0.000;
    0.000  0.008  0.000  0.000 0.000];
dh2=dh;
dh3=dh;
dh4=dh;
dh2(:,1)=[pi/4;-pi/2;0;0;0;0]*180/pi;
dh3(:,1)=[pi/5;-2*pi/5;-pi/10;pi/2;3*pi/10;-pi/2]*180/pi;
dh4(:,1)=[-0.61;-0.15;-0.30;1.4;1.9;-1.4]*180/pi;
